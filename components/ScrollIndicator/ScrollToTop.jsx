...
export const ScrollToTop = () => {
  ...
  return (
    <div
      className="cursor-pointer animate-bounce text-prussianBlue dark:text-linkWater flex flex-col items-center gap-4 text-xs font-medium tracking-2"
      onClick={onScrollToTopClick}
    >
      <div className="rotate-180">
        <span className="-ml-1 uppercase vertical select-none">back to top</span>
