  ...
  return (
    <section className="section relative">
      <div className="max-w-medium flex flex-col gap-8">
        ...
        <div className="absolute -top-2/4 -left-52 xl:-top-1/3 xl:-left-96 -z-10 scale-[2] lg:scale-[2.3] xl:scale-[3.6]">
          <Image src="/images/gradient-blob.svg" alt="Gradient blob" width={800} height={900} priority={true}/>
        </div>
      </div>
      <div className="hidden lg:block">
        <div className="absolute z-3 top-12 -right-20 scale-50 xl:top-48 xl:right-4 xl:scale-100">
          <Image src="/images/hero-1.png" alt="Hero 1" width={654} height={654} />
        </div>
        <div className="absolute z-2 top-12 right-[300px] scale-75 xl:top-0 xl:right-[500px] xl:scale-100">
          <Image src="/images/hero-2.png" alt="Hero 2" width={236} height={236} />
        </div>
        <div className="absolute z-1 top-32 -right-0 scale-75 xl:scale-100">
