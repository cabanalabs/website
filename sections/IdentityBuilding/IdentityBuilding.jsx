...
export const IdentityBuilding = () => {
  return (
    <section className="max-w-medium xl:max-w-xxl mx-auto xl:my-24">
      <div className={`flex flex-col lg:flex-row gap-6 xl:gap-12 items-center px-8`}>
        ...
        <div className="relative h-[476px] w-[400px] lg:w-[750px] xl:h-[768px] xl:w-[1000px] scale-[.6] md:scale-100 ">
          <div className="absolute mt-2 xl:mt-28 h-[476px] w-[475px] -translate-x-1/2 left-24 xl:left-0 scale-50 xl:transform-none">
            <Image src="/images/ib/ib_real_person.png" layout="fill"/>
          </div>
          <div className="absolute z-10 h-[307px] w-[529px] -right-44 xl:right-28 scale-50 xl:transform-none">
            <Image src="/images/ib/ib_profile_card.png" layout="fill"/>
          </div>
          <div className="z-40 h-[95px] w-[231px] -right-12 absolute xl:right-52 inset-y-[215px] xl:inset-y-[320px] scale-50 xl:transform-none">
            <Image src="/images/ib/ib_badges.png" layout="fill"/>
          </div>
          <div className="z-20 h-[318px] w-[451px] -right-36 -bottom-14 absolute xl:bottom-1 xl:right-32 scale-50 xl:transform-none">
