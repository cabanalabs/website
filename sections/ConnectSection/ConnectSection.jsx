...
export const ConnectSection = () => {
  ...
  return (
    <section className='max-w-[1900px] px-10' id='whatWeCanDoForYou'>
      <div className='bg-cabanaBlue3 rounded-2xl drop-shadow-regular flex flex-col-reverse lg:flex-row justify-center items-center w-full py-10 max-h-[600px] overflow-clip'>
        <div className='space-y-14 ml-80'>
        ...
        <div className='top-[100px] -right-[264px] relative drop-shadow-glow'>
          <Image
            width={1850}
            height={1850}
